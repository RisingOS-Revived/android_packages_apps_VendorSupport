...
class GlobalSettingPrimarySwitchPreference : PrimarySwitchPreference {
    ...
    override fun onAttached() {
        super.onAttached()
        isChecked = Settings.Global.getInt(context.contentResolver,
                key, if (mDefaultValue) 1 else 0) != 0
    }
    ...
    private inner class DataStore : PreferenceDataStore() {
        ...
        override fun getBoolean(key: String, defaultValue: Boolean): Boolean {
            return Settings.Global.getInt(context.contentResolver,
                    key, if (defaultValue) 1 else 0) != 0
        }
    }
}
