...
class GlobalSettingsStore(private val mContentResolver: ContentResolver) : 
    ...
    override fun getStringSet(key: String, defValues: Set<String>?): Set<String>? {
        // Global settings doesn't support string sets, return default
        return defValues
    }

    override fun putStringSet(key: String, values: Set<String>?) {
        // Global settings doesn't support string sets, do nothing
    }
}
