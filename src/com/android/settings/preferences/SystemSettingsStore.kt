...
class SystemSettingsStore(private val mContentResolver: ContentResolver) : 
    androidx.preference.PreferenceDataStore() {

    override fun getBoolean(key: String, defValue: Boolean): Boolean {
        return Settings.System.getIntForUser(mContentResolver, key, if (defValue) 1 else 0, UserHandle.USER_CURRENT) != 0
    }
    ...
    override fun getStringSet(key: String, defValues: Set<String>?): Set<String>? {
        // System settings doesn't support string sets, return default
        return defValues
    }

    override fun putStringSet(key: String, values: Set<String>?) {
        // System settings doesn't support string sets, do nothing
    }
}
